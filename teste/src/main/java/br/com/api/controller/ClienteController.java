...
//		return clienteDAO.findByNome("Alex Nascimento Gonçalves");busca por nome especifico e delimitado, igual esta no banco.
		//busca por nome aproximado aos caracteres repassados.
		return clienteDAO.findByNomeContaining("ex");
